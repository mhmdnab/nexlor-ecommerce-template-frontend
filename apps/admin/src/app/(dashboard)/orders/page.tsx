...
import { Card, DataTable, ErrorState, GradientText, Input, Pagination, Price, StatusBadge, Tabs, formatDate, type Column } from '@repo/ui';
...
export default function OrdersPage() {
  ...
  const columns = useMemo<Column<OrderView>[]>(
    () => [
      ...
      { key: 'createdAt', header: 'Date', sortable: true, cell: (o) => <span className="tabular">{formatDate(o.createdAt)}</span> },
      ...
      { key: 'total', header: 'Total', sortable: true, align: 'right', cell: (o) => <Price cents={o.totals.total} currency={o.currency} className="tabular font-medium" /> },
    ],
    [],
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-0.5 text-sm text-muted-foreground">Track and manage customer orders.</p>
      </div>
